...
let num = '' //creo una variabile con una stringa vuota
...
for (i=1; i>0;){
    ...
    //se input è un numero, verifico che sia uguale alla variabile num (stringa vuota alla prima iterazione). se uguale, alert e fermo l'esecuzione
    if (input===num){      
